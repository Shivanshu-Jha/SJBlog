...
const AddBlog = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-700 overflow-scroll h-full'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <select onChange={e => setCategory(e.target.value)} name="category" className='mt-2 px-3 py-2  text-gray-500  border border-gray-300 outline-none rounded'>
