      ...
      <div className='mx-5 max-w-5xl md:mx-auto mt-6 my-10'>
        ...
        <div className='mt-14 mb-10 max-w-3xl mx-auto'>
          ...
          <div className='flex flex-col gap-4'>
            {Comments.map((item, index) => (
              <div key={index} className='relative bg-primary/2 border border-primary/5 p-4 rounded max-w-xl text-gray-600'>
        ...
        <div className='max-w-3xl mx-auto'>
          ...
          <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
            ...
            <textarea onChange={() => setContent(e.target.value)} value={content} placeholder='Comment' required className='w-full p-2 border border-gray-300 rounded outline-none h-48'></textarea>
