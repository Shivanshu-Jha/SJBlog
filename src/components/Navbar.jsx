...
const Navbar = () => {
    ...
    return (
        // creating a navbar component for navigation
        // and displaying the logo and login button
        <div className='navbar flex justify-between items-center py-5 mx-8 sm:mx-20 xl:mx-32'>
